                    ...
                    <div class="col-xs-12">
                        <ul class="list-inline text-center">
                            @foreach(config('app.keywords') as $keyword)
                                <li><h3><span class="label label-default"><a href="https://www.google.lv/search?q={{$keyword}}" target="_blank">#{{$keyword}}</a></span></h3></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6" style="margin-top: 40px;">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><span class="glyphicon glyphicon-chevron-down"></span> Nekādu lieku tēriņu uz mājas lapas izstrādi <span class="label label-default">ietaupi</span></li>
                            <li><span class="glyphicon glyphicon-chevron-down"></span> Mājaslapa un uzstādīšana <span class="label label-default">bez maksas</span></li>
                            <li><span class="glyphicon glyphicon-chevron-down"></span> Responsīvs mājaslapas dizains <span class="label label-default">tālruņiem un planšetdatoriem</span></li>
                            <li><span class="glyphicon glyphicon-chevron-down"></span> Mūsdienīgs un viens no ātrākajiem serveriem Latvijā <span class="label label-default">progresīvi</span></li>
                            ...
                            <li><span class="glyphicon glyphicon-chevron-down"></span> Paaugstinātu lapas ielādes ātrumu (2x) <span class="label label-default">zibenīgs</span></li>
                        </ul>
                    </div>
                    </section>
